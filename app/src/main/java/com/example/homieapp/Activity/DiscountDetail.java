...
public class DiscountDetail extends AppCompatActivity {
    ...
    String discount_id;
    DatabaseReference product_reference, discount_reference;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        discount_reference.orderByChild("id").equalTo(discount_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                activity_title.setText(discount_name);
            }
        ...
        back.setOnClickListener(view -> startActivity(new Intent(DiscountDetail.this, MainActivity.class)));
    }
